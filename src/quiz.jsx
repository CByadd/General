...
const generateQuiz = (chapters) => {
  ...
  while (selectedQuestions.length < totalQuestions) {
    ...
    if (chapterCounts[chapterIndex] < maxQuestionsPerChapter) {
      ...
      let selected = chapterQuestions.find(q => !usedQuestions.has(q.question));
      if (selected) {
      ...
      {loading ? (
        ...
        <div className="quiz-box-container">
          ...
          <h2>Question {currentQuestion + 1}</h2>
            <img src={quiz[currentQuestion].question} alt="question" className='questionimg' />
          ...
          <ul className={`options-list ${quiz[currentQuestion].layout === 'grid' ? 'grid' : 'grid'}`}>
        ...
        <div className="quiz-results">
          ...
          <div className="results-details">
            ...
            {quiz.map((q, index) => (
              <div key={index} className="result-item">
                ...
                <img src={q.question} alt="question" className='resultquestion'/>
          ...
          <div className="results-summary">
            <h3>Your Score: </h3>
              ...
              <CountUp start={0} end={calculateResults()} delay={.5} duration={2}>
              {({ countUpRef }) => (
               <div>
                <span ref={countUpRef} />
                 </div>
                  )}
                 </CountUp> <p className='linethoeu'></p> {quiz.length}</span> 
